  ...
  return (
    <RouteContainer isPureCenteringEnabled={true}>
      ...
      <a
        ...
        href={t.link.theRichCreatorCommunityStripe}
        target="_blank"
      ...
      <Paragraph size={ParagraphSize.Large}>
        ...
        >
          {' '}
          I got so much nice feedback, and it's rated
          <StarIcon />
      ...
      <VerticalSpacing height={VerticalSpacingHeight.Small} />
      <Paragraph size={ParagraphSize.Large}>
        You can check out the full outline here. And the best thing is that you
        can ask anyone in the community (me including) how to reach these goals.
      </Paragraph>
      <VerticalSpacing height={VerticalSpacingHeight.Large} />
