export const t = {
  app: {
    pbzMobileBankingApp: 'PBZ mobile banking app',
  },
  abstractArt: {
  ...
  home: {
    ...
    paragraph: {
      ...
      otherSkills:
        'On the non-technical side, I was involved in Product Management, Sales, Business Management, and Rebranding.',
      hobbies:
        'I like to fill my free time with photography, sports, writing, and reading. Most of the time backed up with electronic music.',
      profiles: {
        pt1: 'Check out my profiles on ',
        pt2: ', ',
        pt3: ', and ',
        pt4: ' or contact me at ',
  ...
  link: {
    ...
    treblle: 'https://treblle.com/product/aspen?utm_source=instagram&utm_medium=domagoj&utm_campaign=aspen_collections',
    ...
    jamNewest:
      'https://jam.dev/?utm_source=tiktok&utm_medium=paid&utm_campaign=tiktok_sponsorship_techwizzdom_2024_11',
    ...
    storyblok:
      'https://www.storyblok.com/technologies?utm_source=influencers&utm_medium=socialmedia&utm_campaign=DGM_DEV_TWD_TRA&utm_content=techWizzDom',
  ...
  study: {
    ...
    bachelor: 'Bachelor of Science in Computing',
  },
  symbol: {
    dot: '.',
  },
